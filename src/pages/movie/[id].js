...
const API_KEY = '81b96cc279a614e8509092a293e952b4';
    ...
    <>
      ...
      <div class="card mb-3 bg-dark text-white">
        <div class="row no-gutters">
          <div class="col-md-4">
            <Image class="card-img-top" src={"https://image.tmdb.org/t/p/original" + data.poster_path} alt={data.original_title} width={450} height={550} layout='fixed' />
          </div>
          <div class="col-md-8">
            <div class="card-body">
